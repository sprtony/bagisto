                    ...
                    <accordian :title="'{{ __('imagegallery::app.images.edit.accordian_title') }}'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                                <label for="title"
                                    class="required">{{ __('imagegallery::app.images.edit.title') }}</label>
                                <input type="text" v-validate="'required'" class="control" id="title" name="title"
                                    value="{{ old('title') ?: $category->title }}"
                                    data-vv-as="&quot;{{ __('Image Title') }}&quot;" />
                                <span class="control-error" v-if="errors.has('title')">@{{ errors.first('title') }}</span>
                            </div>

                            <div class="control-group" :class="[errors.has('description') ? 'has-error' : '']">
                                <label for="description">{{ __('imagegallery::app.images.edit.description') }}</label>
                                <input type="text" class="control" id="description" name="description"
                                    value="{{ old('description') ?: $category->description }}"
                                    data-vv-as="&quot;{{ __('Description') }}&quot;" />
                                <span class="control-error" v-if="errors.has('description')">@{{ errors.first('description') }}</span>
                            </div>

                            <div class="control-group" :class="[errors.has('sort') ? 'has-error' : '']">
                                <label for="sort"
                                    class="required">{{ __('imagegallery::app.images.edit.sort') }}</label>
                                <input type="text" v-validate="'required|numeric'" class="control" id="sort"
                            ...
                            <div class="control-group" :class="[errors.has('status') ? 'has-error' : '']">
                                <label for="status"
                                    class="required">{{ __('imagegallery::app.images.edit.status') }}</label>
