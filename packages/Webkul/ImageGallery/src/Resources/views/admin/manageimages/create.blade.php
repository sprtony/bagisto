                ...
                <accordian :title="'{{ __('imagegallery::app.images.create.accordian_title') }}'" :active="true">
                    <div slot="body">
                        ...
                        <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                            <label for="title"
                                class="required">{{ __('imagegallery::app.images.create.title') }}</label>
                            <input type="text" v-validate="'required'" class="control" id="title" name="title"
                                value="{{ old('title') }}" data-vv-as="&quot;{{ __('Image Title') }}&quot;"
                                v-slugify-target="'slug'" />
                            <div>{{ __('imagegallery::app.images.create.title_msg') }}</div>
                            <span class="control-error" v-if="errors.has('title')">@{{ errors.first('title') }}</span>
                        </div>
                        <div class="control-group" :class="[errors.has('description') ? 'has-error' : '']">
                            <label for="">{{ __('imagegallery::app.images.create.description') }}</label>
                            <input type="text" class="control" id="description" name="description"
                                value="{{ old('description') }}" data-vv-as="&quot;{{ __('Description') }}&quot;"
                                v-slugify-target="'slug'" />
                        ...
                        <div class="control-group" :class="[errors.has('sort') ? 'has-error' : '']">
                            <label for="sort"
                                class="required">{{ __('imagegallery::app.images.create.sort') }}</label>
                            <input type="text" v-validate="'required|numeric'" class="control" id="sort" name="sort"
                                value="{{ old('sort') }}" data-vv-as="&quot;{{ __('Sort') }}&quot;"
                                v-slugify-target="'slug'" />
                        ...
                        <div class="control-group {!! $errors->has('image.*') ? 'has-error' : '' !!}">
                            ...
                            <image-wrapper :button-label="'{{ __('imagegallery::app.images.create.btn_label') }}'"
                        ...
                        <div class="control-group" :class="[errors.has('status') ? 'has-error' : '']">
                            <label for="status"
                                class="required">{{ __('imagegallery::app.images.create.status') }}</label>
                            <select class="control" v-validate="'required'" id="status" name="status"
                                data-vv-as="&quot;{{ __('Status') }}&quot;">
                                <option value="1">
