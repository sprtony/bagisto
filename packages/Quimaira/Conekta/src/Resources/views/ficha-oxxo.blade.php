...
<head>
    ...
    <link href="{{ asset('vendor/quimaira/conekta/css/conekta.css') }}" media="all" rel="stylesheet"
        type="text/css" />
...
<body>
    <div class="opps">
        <div class="opps-header">
            ...
            <div class="opps-info">
                <div class="opps-brand"><img src="{{ asset('vendor/quimaira/conekta/images/oxxopay_brand.png') }}"
                        alt="OXXOPay"></div>
                <div class="opps-ammount">
                    <h3>Monto a pagar</h3>
                    <h2>$ {{ number_format($order->grand_total, 2) }} <sup>MXN</sup></h2>
                    <p>OXXO cobrará una comisión adicional al momento de realizar el pago.</p>
                </div>
            </div>
            <div class="opps-reference">
                <h3>Referencia</h3>
                <h1>{{ $order->external_payment_id }}</h1>
            </div>
        </div>
        <div class="opps-instructions">
            ...
            <div class="opps-footnote">Al completar estos pasos recibirás un correo de <strong>Nombre del
                    negocio</strong> confirmando tu pago.</div>
        </div>
    </div>
</body>
